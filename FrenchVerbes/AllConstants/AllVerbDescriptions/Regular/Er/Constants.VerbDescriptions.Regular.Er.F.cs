    ...
    public static partial class VerbDescriptions
    {
        public static partial class Regular
        {
            public static partial class Er
            {
                ...
                public const string Forcer = "Forcer signifie contraindre quelqu'un à faire quelque chose, exercer une pression ou surmonter une résistance par la force. C'est un verbe régulier du premier groupe en -er.";
